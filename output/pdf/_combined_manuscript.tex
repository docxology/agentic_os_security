...
This revision (0.2.0) refreshes the evidence base through September 11,
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth,height=0.5\textheight,keepaspectratio,alt={The candidate--property stance matrix across 24 candidates and 9 properties, rendered from output/data/evaluation\_matrix.csv with colorblind-safe encoding of the strong/partial/weak/n\_a vocabulary.}]{../figures/property_matrix.png}
\caption{The candidate--property stance matrix across 24 candidates and
9 properties, rendered from output/data/evaluation\_matrix.csv with
colorblind-safe encoding of the strong/partial/weak/n\_a
vocabulary.}\label{fig:property_matrix}
\end{figure}
...
matrix captures that second view as data.
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth,height=0.5\textheight,keepaspectratio,alt={The defensive-stack matrix: 24 candidates scored against eight mitigation classes --- memory safety, allocator hardening, sandboxing primitives, MAC framework, verified boot, reproducible deployment, disposable execution, and update automation --- using the strong/partial/weak/n\_a stance vocabulary, rendered from output/data/defensive\_stack.csv with candidate categories grouped and per-class coverage shown as a marginal bar.}]{../figures/defensive_stack.png}
\caption{The defensive-stack matrix: 24 candidates scored against eight
mitigation classes --- memory safety, allocator hardening, sandboxing
primitives, MAC framework, verified boot, reproducible deployment,
disposable execution, and update automation --- using the
strong/partial/weak/n\_a stance vocabulary, rendered from
output/data/defensive\_stack.csv with candidate categories grouped and
per-class coverage shown as a marginal bar.}\label{fig:defensive_stack}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth,height=0.5\textheight,keepaspectratio,alt={Documented support and update posture across the 24 candidates, drawn as horizontal timeline bars and colored by candidate category, with an explicit ``policy-defined'' annotation where a project states no fixed support window instead of a fabricated duration. The figure supports the argument of sec.~: maintenance clocks are heterogeneous, documented, and part of the security architecture an operator must compose --- they are not security scores.}]{../figures/update_windows.png}
\caption{Documented support and update posture across the 24 candidates,
drawn as horizontal timeline bars and colored by candidate category,
with an explicit ``policy-defined'' annotation where a project states no
fixed support window instead of a fabricated duration. The figure
supports the argument of sec.~\ref{sec:servers}: maintenance clocks are
heterogeneous, documented, and part of the security architecture an
operator must compose --- they are not security
scores.}\label{fig:update_windows}
\end{figure}
...
not as an endorsement of any tool's security.
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth,height=0.5\textheight,keepaspectratio,alt={The agent capability surface: six capability classes --- content intake, tool and bridge use, credential touch, external communication, state mutation, and self-modification --- crossed with the ten mediation points of this section's taxonomy, numbered 1 through 10: sandbox primitives, egress proxy, tool annotations, OAuth resource-server binding, URL-mode elicitation, agent-to-agent transport security, agent identity exchange, classifier escalation, sandbox observability, and external approval. Dense rows indicate capability classes with layered mechanical coverage; the content-intake row shows where approval and review, rather than mediation, carry the control.}]{../figures/agent_surface.png}
\caption{The agent capability surface: six capability classes ---
content intake, tool and bridge use, credential touch, external
communication, state mutation, and self-modification --- crossed with
the ten mediation points of this section's taxonomy, numbered 1 through
10: sandbox primitives, egress proxy, tool annotations, OAuth
resource-server binding, URL-mode elicitation, agent-to-agent transport
security, agent identity exchange, classifier escalation, sandbox
observability, and external approval. Dense rows indicate capability
classes with layered mechanical coverage; the content-intake row shows
where approval and review, rather than mediation, carry the
control.}\label{fig:agent_surface}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth,height=0.5\textheight,keepaspectratio,alt={The 2028--2031 forecast horizon: the registered forecast claims grouped by confidence tier --- high-confidence architectural bets, moderate execution-dependent outcomes, and low-confidence claims the analysis declines to endorse --- across operating-system architecture, agent authority, and supply-chain domains. The horizon bounds this review's expectations; it is not a release schedule for any project.}]{../figures/forecast_horizon.png}
...
\texttt{references.bib} --- 156 entries comprising primary vendor
documentation, security advisories, incident reports, standards-body
specifications and guidance, and scholarly anchors; no entries are
listed by hand.
